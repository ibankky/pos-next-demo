...
export default function PhoneInputModal({ open, onClose,}) {
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      ...
      <DialogContent className="bg-gray-100 p-10 max-w-sm w-full rounded-xl">
        <div className="text-center text-3xl font-semibold border-2 border-purple-500 rounded-xl py-2 text-purple-600 mb-4">
          {phone}
        </div>
